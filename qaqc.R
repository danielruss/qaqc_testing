...
runQC <- function(data, rules, QC_report_location,ids){
  ...
  bind_rows(
    ...
    rules %>% filter(tolower(Qctype)==tolower("valid")) %>% pmap_dfr(valid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("valid before date()")) %>% pmap_dfr(validBeforeDate,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossvalid before date()")) %>% pmap_dfr(crossvalidBeforeDate,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or valid before date()")) %>% pmap_dfr(na_or_validBeforeDate,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossvalid before date()")) %>% pmap_dfr(na_or_crossvalidBeforeDate,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or valid")) %>% pmap_dfr(na_or_valid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("is populated")) %>% pmap_dfr(isPopulated,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("is not populated")) %>% pmap_dfr(isNotPopulated,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("isNumeric")) %>% pmap_dfr(isNumeric,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 isNumeric")) %>% pmap_dfr(crossvalid_isNumeric,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or isNumeric")) %>% pmap_dfr(na_or_isNumeric,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid1 isNumeric")) %>% pmap_dfr(na_or_crossvalid_isNumeric,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1")) %>% pmap_dfr(crossvalid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid2")) %>% pmap_dfr(crossvalid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid3")) %>% pmap_dfr(crossvalid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid4")) %>% pmap_dfr(crossvalid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 is populated")) %>% pmap_dfr(crossvalidIsPopulated,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 is not populated")) %>% pmap_dfr(crossvalidIsNotPopulated,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid1")) %>% pmap_dfr(na_or_crossvalid,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid2")) %>% pmap_dfr(na_or_crossvalid,data=data,ids={{ids}},date=run_date),
    ...
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 equal to char()")) %>% pmap_dfr(crossvalid_has_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid1 equal to char()")) %>% pmap_dfr(crossvalid_has_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or equal to char()")) %>% pmap_dfr(na_or_has_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 equal to or less than char()")) %>% pmap_dfr(crossvalid_has_less_than_or_equal_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid1 equal to or less than char()")) %>% pmap_dfr(na_or_crossvalid_has_less_than_or_equal_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or equal to or less than char()")) %>% pmap_dfr(na_or_has_less_than_or_equal_n_characters,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("match cid values")) %>% pmap_dfr(match_cid_values,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossvalid match cid values")) %>% pmap_dfr(crossvalid_match_cid_values,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("na or match cid values")) %>% pmap_dfr(na_or_match_cid_values,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("na or crossvalid match cid values")) %>% pmap_dfr(na_or_crossvalid_match_cid_values,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("is 24hr time")) %>% pmap_dfr(is_24hr_time,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or is 24hr time")) %>% pmap_dfr(na_or_is_24hr_time,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("crossValid1 or is 24hr time")) %>% pmap_dfr(crossvalid_is_24hr_time,data=data,ids={{ids}},date=run_date),
    rules %>% filter(tolower(Qctype)==tolower("NA or crossValid1 is 24hr time")) %>% pmap_dfr(na_or_crossvalid_is_24hr_time,data=data,ids={{ids}},date=run_date)
  )
}
...
if (load_from_bq){
  ...
  else if (QC_REPORT == "blood_urine_mouthwash") {
    source("get_merged_blood_urine_mouthwash_data.R")
    data <- get_merged_blood_urine_mouthwash_data(project)
    exceptions <- config::get(value="exceptions", config = "blood_urine_mouthwash")
    exceptions <- union(names(data), exceptions) # get only the ones that are actually in the df
    data <- check_and_correct_exceptions(data, exceptions)
  }
