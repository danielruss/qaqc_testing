...
write.csv(qc1_blood,paste(local_drive, "Mismatched_Blood_Accession_IDs",currentDate,".csv",sep="_"),row.names = F,na="")
...
write.csv(qc1_urine,paste(local_drive, "Mismatched_Urine_Accession_IDs",currentDate,".csv",sep="_"),row.names = F,na="")
...
write.csv(dup_list,paste(local_drive, "Duplicate_Baseline_Biospecimen_Collections",currentDate,".csv",sep="_"),row.names = F,na="")
